...
class TestErrors(TestBase):
    ...
    def test_30_not_found_movie(self):
    ...
    def test_31_bad_request_movie_creation(self):
    ...
    def test_32_duplicate_user_registration(self):
    ...
    def test_33_invalid_login_credentials(self):
    ...
    def test_34_gateway_resilience(self):
