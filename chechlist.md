...
- [ ] **Xác định 4 tầng (Layers):**
    - [ ] Presentation Layer (API Controllers)
    - [ ] Business Logic Layer (Services)
    - [ ] Persistence Layer (Repositories)
    - [ ] Data Layer (Database)
- [ ] **Vẽ sơ đồ Component (Component Diagram):**
    - [ ] Minh họa flow: `MovieController` -> `MovieService` -> `MovieRepository`.
    - [ ] Định nghĩa Interface cho các component này.

### Lab 3: Hiện thực hóa (Implementation)
- [ ] **Setup Project Python Flask:**
    - [ ] Cấu trúc thư mục: `presentation/`, `business_logic/`, `persistence/`.
